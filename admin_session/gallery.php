...
// AMBIL SEMUA FOTO
$stmt = mysqli_prepare($koneksi, "SELECT id, nama_foto, deskripsi, file_foto, created_at FROM photos ORDER BY created_at DESC");
...
<?php include 'sidebar.php'; ?>
    ...
    <main class="content">
        ...
        <!-- Grid Foto -->
        <div class="card">
            <h2>Daftar Foto (<?= count($photos) ?>)</h2>
                        ...
                        <div class="photo-card">
                            ...
                            <div class="body">
                                ...
                                <div class="actions" style="margin-top: 12px;">
                                    ...
                                    <button class="btn btn-danger btn-sm" onclick="deletePhoto(<?= $photo['id'] ?>, '<?= htmlspecialchars(addslashes($photo['nama_foto'])) ?>')">
        ...
        <div class="modal">
            ...
            <form action="upload_foto.php" method="POST" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" name="nama_foto" class="form-control" required placeholder="Contoh: Kegiatan Belajar">
                </div>
    ...
    <div class="modal-bg" id="editModal">
        <div class="modal">
            ...
            <form action="update_foto.php" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <label>Nama Foto *</label>
                    <input type="text" name="nama_foto" id="edit_nama" class="form-control" required>
                </div>
    ...
    <script>
        ...
        function editPhoto(photo) {
            ...
            document.getElementById('edit_nama').value = photo.nama_foto;
            document.getElementById('edit_deskripsi').value = photo.deskripsi;
            document.getElementById('edit_preview').src = 'uploads/galeri/' + photo.file_foto;
            openModal('editModal');
        }
